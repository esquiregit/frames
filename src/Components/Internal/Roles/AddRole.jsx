...
function AddRole({ history, closeModal, reload, permissions }) {
    React.useEffect(() => {  
        if(!permissions.includes("Can Create Role")) {
    ...
    return (
        <>
            ...
            { showDialogue && <ConfirmDialogue message={'Are You Sure You Want To Add Role?'} closeConfirm={closeConfirm} /> }
